meta = read.table("C:\\Users\\gbj\\Documents\\BACKUP\\FQHL_bok\\metastudy analysis\\data\\metastudy assessments.csv", header=T,sep="\t")
...
source("C:\\Users\\gbj\\Documents\\BACKUP\\R\\cramer.r")
 cv.test(meta.qq)
#
# - - - - - - - - - - - - - - - - - - - - -
